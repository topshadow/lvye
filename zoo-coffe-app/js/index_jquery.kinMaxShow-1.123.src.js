	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'50px',height:'5px',left:"50%",bottom:'20px',fontSize:'0',background:'#fff',marginRight:'8px',float:'left'},
								//当前 按钮样式
								focus:{background:'#c0192a'}
							},
			...
			var btnCenter = $("#bottom_banner div").length*50/2;
